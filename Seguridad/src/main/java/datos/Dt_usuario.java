...
public class Dt_usuario {
	...
	//Method to full the RusultSet //for insert, update and delete
	...
	//Method for visualize register users and active
	public ArrayList<Tbl_user> listaUserActivos(){
		ArrayList<Tbl_user> listUser = new ArrayList<Tbl_user>();
		try{
			c = poolConexion.getConnection(); //get a connection from pool
			...
			rs = ps.executeQuery();
			while(rs.next()){
				Tbl_user user = new Tbl_user(); //instantiate to user
